...
Cobertura de eventing: La Liga (Biwenger + SofaScore), las 5 grandes ligas europeas completas, y el resto de ligas —Segunda incluida— bajo demanda por jugador cuando aparece un fichaje. **Segunda se trata como una liga de origen más** (decidido el 2026-07-16; revisa la decisión del 2026-07-10 de backfillearla completa): sin backfill dedicado ni re-ingesta al cierre de temporada; el historial de un jugador de Segunda se descarga bajo demanda cuando llega a La Liga, por el detector de fichajes o `ingest sofascore --player`. Además de las ligas, se ingieren los fixtures y alineaciones de Copa del Rey y competiciones UEFA para los equipos de La Liga (densidad de calendario del modelo de minutos) y las páginas de competición de Transfermarkt (valor de plantilla por club, base del nivel de equipo y de liga).
